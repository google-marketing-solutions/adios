...
// function testGetAdgroupExtensionSettings() {
//   if (!CONFIG['Ads API Key']) {
...
//     '9044713567'
//   );
//   const results = googleAdsApi.executeSearch(
...
//     '9044713567'
//   );
//   const results = googleAdsApi.executeSearch(GoogleAdsApi.QUERIES.FEED_ITEMS);
//   Logger.log(results);
// }
...
//   );
//   const results = googleAdsApi.executeSearch(
//     GoogleAdsApi.QUERIES.ASSETS +
//       " AND asset.name LIKE 'south-africa_diving_prices_g1_br%'"
//   );
//   Logger.log(results);
// }

// function testGetAssetsForAdGroup() {
//   if (!CONFIG['Ads API Key']) {
//     Logger.log('API Key not set!');
//     return;
//   }
...
//     '9044713567'
//   );
//   Logger.log(googleAdsApi.getAssets('south-africa_diving_prices_g1_br'));
// }
